...
export function FinalCTA() {
  return (
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-neural-teal/20 rounded-full blur-3xl" />
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="font-display text-4xl md:text-5xl lg:text-display-sm font-bold text-white leading-tight mb-8">
            ...
            <span className="block mt-2">
              <span className="gradient-text-rose">Your Product Photos?</span>
            </span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
            <div className="flex items-center gap-2 text-white/80">
              ...
              <span className="font-medium">3 free images</span>
            </div>
