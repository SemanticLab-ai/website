        ...
        <GlassCard className="relative overflow-hidden">
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="grid gap-4 md:gap-6 grid-cols-1 sm:grid-cols-2 max-w-xl mx-auto mb-10">
              {highlights.map((feature) => (
                <div key={feature} className="flex items-center gap-4 group">
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-neural-teal to-cyan-400 flex items-center justify-center group-hover:scale-110 transition-transform">
            ...
            <div className="text-center">
              <CTAButton href="/products/image-enhancer/pricing">
                See Full Pricing
