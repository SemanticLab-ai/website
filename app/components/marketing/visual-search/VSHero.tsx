...
export function VSHero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden mesh-gradient-rose noise-overlay">
      <div className="absolute top-20 right-[10%] w-[500px] h-[500px] bg-neural-teal/20 blob blob-animated blur-3xl" />
      <div className="absolute bottom-20 left-[5%] w-[400px] h-[400px] bg-vector-rose/15 blob blob-animated blur-3xl" style={{ animationDelay: "2s" }} />
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="font-display text-5xl md:text-6xl lg:text-display font-bold text-charcoal mb-8">
            ...
            <span className="block mt-2">
              Your Shoppers{" "}
              <span className="gradient-text-teal italic">Deserve</span>
            </span>
          </h1>

          <p className="text-xl md:text-2xl text-slate leading-relaxed mb-10 max-w-2xl mx-auto">
            Fashion-specific AI that understands{" "}
            <span className="text-charcoal font-semibold">"like this but longer sleeves"</span>
            {" "}and turns browsing into buying.
          </p>

          <Button
            size="lg"
            className="h-14 px-8 text-lg rounded-full bg-gradient-to-r from-neural-teal to-neural-teal-dark text-white shadow-xl transition-all duration-300 hover:scale-105 group"
          >
