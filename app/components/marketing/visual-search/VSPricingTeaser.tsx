      ...
      <div className="container mx-auto px-6 lg:px-8 relative">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="font-display text-4xl md:text-5xl lg:text-h1 font-bold text-charcoal leading-tight mb-6">
            Pricing That{" "}
            <span className="gradient-text italic">Scales With You</span>
          </h2>

          <p className="text-lg text-slate">
            From <span className="text-charcoal font-semibold">$99/mo</span> for growing stores to custom enterprise plans.
          </p>
        </div>
          ...
          <div className="relative bg-white rounded-3xl shadow-2xl shadow-charcoal/10 overflow-hidden border border-slate/10">
            ...
            <div className="p-8 md:p-12">
              ...
              <div className="text-center">
                <Button
                  size="lg"
                  className="h-14 px-10 text-lg rounded-full bg-gradient-to-r from-neural-teal to-neural-teal-dark text-white shadow-xl transition-all duration-300 hover:scale-105 group"
                  asChild
                >
